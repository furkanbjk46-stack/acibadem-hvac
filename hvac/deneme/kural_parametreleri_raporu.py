...
def build():
    ...
    rows = [
        ...
        ["TOLERANCE_CRITICAL", "±1.0°C", "ΔT, hedeften bu kadar saparsa kritik tolerans disi sayilir",
    ...
    rows7 = [
        ...
        ["LOW_FLOW_DETECTED", "8.0", "CRITICAL", "AHU + FCU (Chiller haric)",
         "Inlet/Outlet ΔT >= 15°C VE SAT < 27°C"],
        ...
        ["HEAT_EFF_LOW", "7.0", "CRITICAL", "Sadece AHU",
         "Heat Valve >=%90 + ufleme (SAT) < SAT_HEATING_MIN (27°C)"],
