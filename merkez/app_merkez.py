...
<svg width="100%" height="100%" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMid slice"
  ...
  <defs>
    ...
    <radialGradient id="landGradm" cx="50%" cy="50%" r="50%">
      <stop offset="0%"   stop-color="#10b981" stop-opacity="0.28"/>
      <stop offset="100%" stop-color="#065f46" stop-opacity="0.05"/>
    </radialGradient>
    <filter id="softglowm" x="-80%" y="-80%" width="260%" height="260%">
      <feGaussianBlur stdDeviation="6" result="blur"/>
      <feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
    </filter>
    <filter id="iconGlowm" x="-100%" y="-100%" width="300%" height="300%">
      <feGaussianBlur stdDeviation="4" result="blur"/>
      <feMerge><feMergeNode in="blur"/><feMergeNode in="SourceGraphic"/></feMerge>
    </filter>
    <clipPath id="globeClipm">
  ...
  <g opacity="0.13">
    ...
    <circle cx="800" cy="450" r="340" fill="url(#globeGradm)"/>
    <g clip-path="url(#globeClipm)" stroke="rgba(56,189,248,0.22)" stroke-width="0.7" fill="none">
    ...
    <g clip-path="url(#globeClipm)" fill="url(#landGradm)" stroke="rgba(16,185,129,0.3)" stroke-width="0.8">
      ...
      <path d="M770,455 C790,445 820,448 840,460 C858,472 862,500 855,530
               C848,558 830,575 808,578 C785,580 766,562 758,538 C748,510 748,470 770,455Z"/>
  ...
  <g opacity="0.10">
    <circle cx="800" cy="450" r="370" fill="none"
            stroke="rgba(56,189,248,0.5)" stroke-width="0.5" stroke-dasharray="4 12"/>
  </g>

  <!-- RÜZGAR TÜRBİNİ 1 (sağ) -->
  <g transform="translate(1380,520)" opacity="0.22" filter="url(#softglowm)">
  ...
  <!-- RÜZGAR TÜRBİNİ 2 (sol) -->
  <g transform="translate(180,620) scale(0.55)" opacity="0.16" filter="url(#softglowm)">
    <polygon points="-7,0 7,0 4,-260 -4,-260" fill="rgba(100,180,255,0.6)"/>
    <ellipse cx="0" cy="2" rx="22" ry="6" fill="rgba(100,180,255,0.3)"/>
    <g>
      <animateTransform attributeName="transform" type="rotate"
  ...
  <g transform="translate(60,680) rotate(-12)" opacity="0.18">
    ...
    <ellipse cx="110" cy="70" rx="130" ry="80" fill="url(#heat1m)">
    ...
    <ellipse cx="110" cy="70" rx="90" ry="55" fill="url(#heat2m)">
    ...
    <line x1="30" y1="10" x2="190" y2="130" stroke="rgba(255,200,80,0.12)" stroke-width="40" stroke-linecap="round">
      <animate attributeName="opacity" values="0;0.5;0" dur="4s" repeatCount="indefinite"/>
    </line>
  </g>

  <!-- GÜNEŞ PANELİ 2 (sağ-alt) -->
  ...
  <!-- Yaprak -->
  <g transform="translate(310,180)" opacity="0.18" filter="url(#iconGlowm)">
    <path d="M0,60 C-10,30 5,-10 40,-30 C60,-40 85,-35 90,-20 C95,-5 80,20 60,35 C40,50 15,65 0,60Z"
  ...
  <!-- Şimşek -->
  <g transform="translate(1240,140)" opacity="0.18" filter="url(#iconGlowm)">
    <path d="M30,0 L10,45 L25,45 L5,90 L45,35 L28,35 L50,0Z"
          fill="rgba(250,204,21,0.8)" stroke="rgba(250,204,21,0.5)" stroke-width="1.5" stroke-linejoin="round"/>
    <animate attributeName="opacity" values="0.18;0.28;0.18" dur="2.5s" repeatCount="indefinite"/>
  </g>
  <!-- Güneş simgesi -->
  <g transform="translate(95,760)" opacity="0.16" filter="url(#iconGlowm)">
  ...
  <!-- Yaprak 2 -->
  <g transform="translate(1490,700)" opacity="0.14" filter="url(#iconGlowm)">
    <path d="M0,50 C-8,25 4,-8 32,-24 C50,-34 70,-28 72,-15 C74,-2 62,18 46,30 C30,42 10,54 0,50Z"
  ...
  <!-- Dalga -->
  <g transform="translate(680,820)" opacity="0.12" filter="url(#iconGlowm)">
